          ...
          <thead class='thead-light'>
			...
			cart.map((item) => {
				...
				table += `
                   ...
                   <td>$.${formatCurrency.format(item.productPrice)}/-</td>
                   <td>$.${formatCurrency.format(productTotalPrice)}/-</td>
			...
			table = table + `<tr><td class='colspan='5' class='text-center font-weight-bold'>Total a Pagar: $ ${formatCurrency.format(totalPrice)}/-
